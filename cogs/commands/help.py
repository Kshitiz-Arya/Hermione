...
from command import read, save, get_prefix
...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        owner = 'Kshitiz'	# ENTER YOU DISCORD-ID
        owner_name = 'Kshitiz#2334'	# ENTER YOUR USERNAME#1234
        ...
        if not input:
            ...
            emb.add_field(name="About", value=f"The Bots is developed by Kshitiz#2334, based on discord.py.")

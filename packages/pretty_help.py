...
class Paginator:
    ...
    def add_command(self, command: commands.Command):
        ...
        page.add_field(
            name="Arguments", value=f"{self.prefix}{args}{self.suffix}", inline=False
        )

        page.add_field(
            name="Command Format", value=f"{self.prefix}{form}{self.suffix}", inline=False
        )

        page.add_field(
            name="Example", value=f"{self.prefix}{example}{self.suffix}", inline=False
        )
